        ...
        <div class="quotation">
            <div class="width100 bg">
                <div class="stock-seo">
                    ...
                    <div class="buy">
                        <a href="javascript:;" class="refresh" @click='refresh'>
                            刷新
                        </a>
                        <a href="javascript:;" class="buy-btn">
                            点买
                        </a>
                    </div>
                    <div class="stock-seo-div">
                        <div class="seo-text">
                            <input type="text" placeholder="输入股票名称／代码／简拼" class="seo-val" @change="seo_stock()"/>
                ...
                <div class="stock-data">
                    <div class="stock-left">
                        <div class="title-main">
                            <a class="active" @click="changeMap(0)">时K</a> <a @click="changeMap()">日K</a>
                        </div>
...
//                  console.log(_this.hot)
        ...
        methods: {
            ...
            retriveMarket() {
                axios.get('/strategist/stock/market/' + this.code)
                    .then(function (response) {
                        this.market = response.data.result;
                        this.market.upDropSpeed = this.market.upDropSpeed * 100 + "%";
                    }.bind(this))
                    .catch(function (error) {
                        console.log(error);
                    });
...
//               var rawData = value === 0 ? timeData : dayData; //分 时k和 日K
                ...
                this.charts.setOption({
                    ...
                    tooltip: {
                        ...
                        position: function (pos, params, el, elRect, size) {//###鼠标再图上移动时的展示框的位置，这样不会超出外图的范围
                            var obj = {top: 10};
